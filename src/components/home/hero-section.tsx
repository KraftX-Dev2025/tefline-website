    ...
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-20 pt-28 pb-32">
        ...
        >
          <motion.div
            variants={fadeIn}
            className="text-teal-600 mb-3 py-2 px-4 bg-white/90 backdrop-blur-md rounded-full text-sm font-medium inline-flex items-center"
          >
            <Sparkles className="w-6 h-6 mr-2" />
            <span className="badge-text text-sm sm:text-base">Redefining Modern Healthcare</span>
          </motion.div>
          <motion.h1
        ...
        >
          ...
          <span className="badge-text">Powered by Agentic Intelligence</span>
        </motion.div>
      </div>
    </section>
  )
